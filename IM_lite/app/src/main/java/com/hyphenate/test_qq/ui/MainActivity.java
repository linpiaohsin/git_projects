...
import com.hyphenate.test_qq.db.InviteMessgeDao;
import com.hyphenate.test_qq.db.UserDao;
import com.hyphenate.test_qq.runtimepermissions.PermissionsManager;
import com.hyphenate.test_qq.runtimepermissions.PermissionsResultAction;
import com.hyphenate.easeui.utils.EaseCommonUtils;
import com.hyphenate.test_qq.view.SlidingMenu;
import com.hyphenate.test_qq.view.SwipeListLayout;
...
public class MainActivity extends BaseActivity {
	...
	public List<String> list = new ArrayList<String>(15);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sharedPreferences=getSharedPreferences("firstLogon",MODE_PRIVATE);
		SharedPreferences.Editor editor=sharedPreferences.edit();
		isFirst=sharedPreferences.getBoolean("isFirstLogon4",true);

		if (isFirst==true){
			jumpToViewPager();
			editor.putBoolean("isFirstLogon4",false);
			editor.commit();
		}
		...
		setContentView(R.layout.layout_first_complex);
		// runtime permission for android 6.0, just require all permissions here for simple
		requestPermissions();
		final List list_catalog=new ArrayList();
		list_catalog.add("简书");
		list_catalog.add("待定");
		list_catalog.add("待定");
		list_catalog.add("待定");
		...
		listView.setAdapter(new com.hyphenate.test_qq.adapter.MenuAdapter(getApplicationContext(),list_catalog));
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				slidingMenu.toggle();
				if (list_catalog.get(position)=="简书"){
					startActivity(new Intent(MainActivity.this,JianShuActivity.class));
				}
